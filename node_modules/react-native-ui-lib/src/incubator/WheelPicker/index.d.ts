...
declare const _default: React.ComponentClass<WheelPickerProps & ThemeComponent, any> & {
    ({ items: propItems, itemHeight, numberOfVisibleRows, activeTextColor, inactiveTextColor, textStyle, label, labelStyle, labelProps, onChange, align, disableRTL, style, children, initialValue, separatorsStyle, testID, faderProps }: WheelPickerProps): JSX.Element;
