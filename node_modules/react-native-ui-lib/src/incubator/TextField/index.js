      ...
      <View style={[margins, positionStyle, containerStyle, centeredContainerStyle]}>
        ...
        <View style={[paddings, fieldStyle]} row centerV centerH={centered}>
          ...
          {children || <View flex={!centered && !inline}>
              ...
              {Constants.isAndroid && (centered || inline) && <Text marginR-s1 style={styles.dummyPlaceholder}>
                  {placeholder}
                </Text>}
              ...
              <Input placeholderTextColor={hidePlaceholder ? 'transparent' : placeholderTextColor} {...others} style={[typographyStyle, colorStyle, others.style]} onFocus={onFocus} onBlur={onBlur} onChangeText={onChangeText} placeholder={placeholder} hint={hint} />
            </View>}
          {trailingAccessory}
          {/* </View> */}
        </View>
